...
freed if a placeholder is holding it, the staging file moved into the chapter the
course is now in, labels rewritten. The procedure is **Opening a new chapter** in
