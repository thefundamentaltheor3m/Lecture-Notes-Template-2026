...
% COURSE-SPECIFIC:
% Macros for the particular course these notes are for. Everything above is
% general enough to be worth carrying between courses; everything below is not.
% Keep the conventions of the blocks above -- p-prefix for a parenthesised
% operator, of-suffix for parenthesised application, \operatorname{} rather than
% \mathrm{}, \! before the delimiter -- and define macros here rather than inline
% in a chapter file.
